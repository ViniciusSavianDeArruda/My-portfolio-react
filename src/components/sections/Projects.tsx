...
const linkCls =
  "inline-flex items-center gap-[0.45rem] font-mono text-[0.75rem] text-[#4ade80] no-underline border border-[#1a4d2e] px-3 py-1.5 transition-all duration-200 hover:text-[#00FF41] hover:border-[#00FF41]";
            ...
            >
              ...
              >
                ...
                <div className="relative md:w-[45%] flex-shrink-0 overflow-hidden bg-[#060f0a] min-h-[220px]">
                  ...
                  <span className="absolute top-3 left-3 font-orbitron text-[0.65rem] text-[#4ade80] bg-[rgba(8,8,8,0.85)] px-2 py-1 z-10">
                    #{project.id}
                  </span>
                </div>
                ...
                <div className="flex flex-col justify-between p-6 md:p-8 flex-1">
                  <div>
                    ...
                    <p className="text-[#bbf7d0] leading-[1.8] text-[0.85rem] mb-5">
                      {project.desc}
                    </p>
                    ...
                    <div className="flex gap-[0.35rem] flex-wrap mb-6">
                      {project.tech.map((t) => (
                        <span
                          key={t}
                          className="font-mono text-[0.65rem] text-[#4ade80] border border-[#1a4d2e] px-2 py-[2px]"
                        >
                          {t}
                        </span>
                      ))}
